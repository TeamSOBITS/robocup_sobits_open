...
SOBITSでは，毎年「RoboCup Japan Open @Home Leage」に参加しており，Pre RoboCup SOBITS Open 2026では，ロボット開発の第一歩として，学生がケーススタディでの学習を通してプログラム開発を行うことを目的としています．
...
この「Pre RoboCup SOBITS Open」が，このような力を身に付けるきっかけとなって，みなさんの今後の研究生活に役立てることができると，とても嬉しく思います．
そして学内外のメンバー問わず，Pre RoboCup SOBITS Openを一緒に盛り上げて，互いに切磋琢磨する機会にしていきましょう！！
...
## Pre RoboCup SOBITS Openに関する各種資料

競技に関するスライドはこちらにあります．

当日のスケジュール: coming soon
